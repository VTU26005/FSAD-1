    ...
    <div className="calculator">
      ...
      <div className="calculator-buttons">
        <div className="button-row">
          ...
          <button className="button function" onClick={() => performOperation("/")}>÷</button>
          <button className="button function" onClick={() => performOperation("*")}>×</button>
          <button className="button function" onClick={() => performOperation("-")}>−</button>
        </div>
        ...
        <div className="button-row">
          ...
          <button className="button function" onClick={() => performOperation("+")} style={{gridRow: "span 2"}}>+</button>
        </div>
        ...
        <div className="button-row">
          ...
          <button className="button equals" onClick={performCalculation} style={{gridRow: "span 2"}}>=</button>
        </div>
        
        <div className="button-row">
          <button className="button number" onClick={() => inputNumber(0)} style={{gridColumn: "span 2"}}>0</button>
          <button className="button number" onClick={inputDecimal}>.</button>
        </div>
        
        <div className="button-row">
          <button className="button special" onClick={findFactorial}>x!</button>
          <button className="button special" onClick={findSquareRoot}>√</button>
        </div>
      </div>
    </div>
  );
